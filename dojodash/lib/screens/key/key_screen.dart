...
class KeyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            title: Text('Key Finder Scores'),
            actions: getActionButtons(context)),
        body:
            endpoint.onDashboardData((data) => KeyDashboard(UniqueKey(), data)),
        bottomNavigationBar: ElevatedButton(
            child: Text('Key Finder Server Status'),
            onPressed: () => context.yeet('/keyserver')));
  }
}
